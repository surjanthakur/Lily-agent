  ...
  return (
    ...
    >
      <div className="mx-auto max-w-6xl">
        <div className="text-reveal mb-10 flex items-center justify-center gap-2 text-center text-2xl font-black text-neutral-950 sm:text-3xl">
          <FlowerAccent className="h-10 w-10 shrink-0" />
          <span>Let&apos;s see how Lily agent work</span>
        </div>

        <div className="text-reveal mx-auto max-w-5xl overflow-hidden rounded-[28px] border border-sky-200/70 bg-sky-950/5 shadow-[0_28px_80px_rgba(14,116,144,0.15)]">
          {embedUrl ? (
