      ...
      <div className="flex items-center justify-between gap-3 rounded-2xl bg-[#181818] px-2.5 py-2 ring-1 ring-white/10 dark:bg-white dark:ring-black/20">
        <div className="flex min-w-0 items-center gap-3">
          ...
          <div className="min-w-0">
            <p className="truncate text-sm font-medium text-white dark:text-black">
              surjan thakur
            </p>
          </div>
        </div>
        ...
        <button
          ...
          className="flex h-9 w-9 items-center justify-center rounded-full border border-white/10 bg-white/5 text-white transition hover:bg-white/10 dark:border-black/20 dark:bg-black/5 dark:text-black"
        >
          <Settings2 size={20} />
        </button>
      </div>
