  ...
  return (
    <header className="border-b border-white/10 bg-[#181818] px-3 py-3 sm:px-4 sm:py-4">
      ...
      <div className="mt-4">
        <button
          type="button"
          className="flex w-full items-center justify-center gap-2 rounded-full bg-[#dfe2e8] px-4 py-3 text-base font-medium text-[#1a1f2a] shadow-lg shadow-slate-900 transition hover:bg-white"
        >
          <Magicpen size={20} />
          <span>New chat</span>
        </button>
